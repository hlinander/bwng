...
CREATE TABLE jobs (
	...
	model1_result_id INT UNSIGNED DEFAULT NULL,
	model2_result_id INT UNSIGNED DEFAULT NULL,
	state INT DEFAULT 0,
	created TIMESTAMP DEFAULT NOW(),
	FOREIGN KEY (generation_id) REFERENCES generations(id),
	FOREIGN KEY (model1_id) REFERENCES models(id),
	FOREIGN KEY (model2_id) REFERENCES models(id),
	FOREIGN KEY (model1_result_id) REFERENCES models(id),
	FOREIGN KEY (model2_result_id) REFERENCES models(id)
);
