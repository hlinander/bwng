...
arg_parser.add_argument('--reset_index', action='store_true', default=False)
arg_parser.add_argument('--reset-models', action='store_true', default=False)
...
arg_parser.add_argument('--db-pass', type=str, default='herdevinstsko')
